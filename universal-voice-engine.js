const UNIVERSAL_VOICE_ENGINE = {
    ...
    prompts: {
        'en': {
            ...
            numProducts: "How many products do you have? Please say a number between 0 and 100.",
            numServices: "How many services do you have? Please say a number between 0 and 100.",
        ...
        'ml': {
            ...
            numProducts: "നിങ്ങൾക്ക് എത്ര ഉൽപ്പന്നങ്ങൾ (Products) ഉണ്ട്? പൂജ്യത്തിനും നൂറിനും ഇടയിലുള്ള ഒരു എണ്ണം പറയുക.",
            numServices: "നിങ്ങൾക്ക് എത്ര സേവനങ്ങൾ (Services) ഉണ്ട്? പൂജ്യത്തിനും നൂറിനും ഇടയിലുള്ള ഒരു എണ്ണം പറയുക.",
